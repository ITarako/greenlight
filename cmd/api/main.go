...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:postgres@localhost/greenlight", "PostgreSQL DSN")
	...
	defer db.Close()
	logger.PrintInfo("database connection pull established", nil)
